...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateCustomerAssessmentParams = {
      ...
      // 创建产妇护理记录时固定为 1，编辑时保留原值
      careType: isEditMode.value ? values.careType : 1,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新产妇护理记录' : '创建产妇护理记录'"
      width="700px"
