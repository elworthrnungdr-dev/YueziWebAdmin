...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateDoctorRoundRecordParams = {
      ...
      // 创建中医科医生巡房时固定为 4，编辑时保留原值
      roundType: isEditMode.value ? values.roundType : 4,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新中医科医生巡房' : '创建中医科医生巡房'"
      width="700px"
