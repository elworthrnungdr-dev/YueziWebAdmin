...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateCustomerAssessmentParams = {
      ...
      // 创建宝宝每日护理记录时固定为 2，编辑时保留原值
      careType: isEditMode.value ? values.careType : 2,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新宝宝每日护理记录' : '创建宝宝每日护理记录'"
      width="700px"
