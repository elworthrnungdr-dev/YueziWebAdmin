...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateDoctorRoundRecordParams = {
      ...
      // 创建新生儿科医生巡房时固定为 1，编辑时保留原值
      roundType: isEditMode.value ? values.roundType : 1,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新新生儿科医生巡房' : '创建新生儿科医生巡房'"
      width="700px"
