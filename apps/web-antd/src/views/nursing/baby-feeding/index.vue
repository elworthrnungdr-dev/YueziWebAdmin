...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateCustomerAssessmentParams = {
      ...
      // 创建宝宝喂养记录时固定为 6，编辑时保留原值
      careType: isEditMode.value ? values.careType : 6,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新宝宝喂养记录' : '创建宝宝喂养记录'"
      width="700px"
