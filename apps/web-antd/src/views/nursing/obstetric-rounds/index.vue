...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateDoctorRoundRecordParams = {
      ...
      // 创建产科医生巡房时固定为 3，编辑时保留原值
      roundType: isEditMode.value ? values.roundType : 3,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新产科医生巡房' : '创建产科医生巡房'"
      width="700px"
