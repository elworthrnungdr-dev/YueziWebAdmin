...
async function handleSubmit() {
  try {
    ...
    const baseData: CreateCustomerAssessmentParams = {
      ...
      // 创建产妇每日查房记录时固定为 4，编辑时保留原值
      careType: isEditMode.value ? values.careType : 4,
...
<template>
  <div class="p-4">
    ...
    <Modal
      ...
      :title="isEditMode ? '更新产妇每日查房记录' : '创建产妇每日查房记录'"
      width="700px"
